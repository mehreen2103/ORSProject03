...
@WebServlet(name = "DataImportListCtl", urlPatterns = { "/ctl/DataImportListCtl" })
public class DataImportListCtl extends BaseCtl {
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op)
                ...
                if (ids != null && ids.length > 0) {
                    ...
                    DataImportDTO deleteBean = new DataImportDTO();
    ...
    protected String getView() {
        return ORSView.DATAIMPORT_LIST_VIEW;
    }
}