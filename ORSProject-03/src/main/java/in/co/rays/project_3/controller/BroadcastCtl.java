...
@WebServlet(urlPatterns = { "/ctl/BroadcastCtl" })
public class BroadcastCtl extends BaseCtl {
    ...
    protected boolean validate(HttpServletRequest request) {
        ...
        if (DataValidator.isNull(request.getParameter("broadcastCode"))) {
            request.setAttribute("broadcastCode",
                    PropertyReader.getValue("error.require", "Broadcast Code"));
            pass = false;
        }
        ...
        if (DataValidator.isNull(request.getParameter("sentBy"))) {
            request.setAttribute("sentBy",
                    PropertyReader.getValue("error.require", "Sent By"));
            pass = false;
        }
