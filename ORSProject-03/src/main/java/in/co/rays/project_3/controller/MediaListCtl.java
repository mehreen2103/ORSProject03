...
@WebServlet(name = "MediaListCtl", urlPatterns = { "/ctl/MediaListCtl" })
public class MediaListCtl extends BaseCtl {
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op)
                ...
                if (ids != null && ids.length > 0) {
                    ...
                    MediaDTO deleteBean = new MediaDTO();
    ...
    protected String getView() {
        return ORSView.MEDIA_LIST_VIEW;
    }
}