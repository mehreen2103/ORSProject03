...
public class AccountListCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("AccountListCtl doGet Start");
		...
		log.debug("AccountListCtl doGet End");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("AccountListCtl doPost Start");
		...
		try {
			...
			if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op) || OP_PREVIOUS.equalsIgnoreCase(op)) {
				...
				if (ids != null && ids.length > 0) {
					...
					AccountDTO deleteDto = new AccountDTO();
			...
			dto = (AccountDTO) populateDTO(request);
		...
		log.debug("AccountListCtl doPost End");
	}
