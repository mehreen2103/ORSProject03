...
@WebServlet(name = "CryptoWalletListCtl", urlPatterns = { "/ctl/CryptoWalletListCtl" })

public class CryptoWalletListCtl extends BaseCtl {

	private static final long serialVersionUID = 1L;

	private static Logger log = Logger.getLogger(CryptoWalletListCtl.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("CryptoWalletListCtl doGet Start");
		...
		log.debug("CryptoWalletListCtl doGet End");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("CryptoWalletListCtl doPost Start");
		...
		try {
			...
			if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op) || OP_PREVIOUS.equalsIgnoreCase(op)) {
				...
				if (ids != null && ids.length > 0) {
					...
					CryptoWalletDTO deleteDto = new CryptoWalletDTO();
			...
			dto = (CryptoWalletDTO) populateDTO(request);
		...
		log.debug("CryptoWalletListCtl doPost End");
	}

	@Override
	protected String getView() {

		return ORSView.CRYPTOWALLET_LIST_VIEW;
	}
}