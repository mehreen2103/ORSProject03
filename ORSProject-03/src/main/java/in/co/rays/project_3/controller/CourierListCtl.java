...
public class CourierListCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("CourierListCtl doGet Start");
		...
		log.debug("CourierListCtl doGet End");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("CourierListCtl doPost Start");
		...
		try {
			...
			if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op) || OP_PREVIOUS.equalsIgnoreCase(op)) {
				...
				if (ids != null && ids.length > 0) {
					...
					CourierDTO deleteDto = new CourierDTO();
			...
			dto = (CourierDTO) populateDTO(request);
		...
		log.debug("CourierListCtl doPost End");
	}
