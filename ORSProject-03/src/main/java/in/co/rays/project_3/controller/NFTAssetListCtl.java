...
public class NFTAssetListCtl extends BaseCtl {
	...
	private static Logger log = Logger.getLogger(NFTAssetListCtl.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("NFTAssetListCtl doGet Start");
		...
		log.debug("NFTAssetListCtl doGet End");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("NFTAssetListCtl doPost Start");
		...
		try {
			...
			dto = (NFTAssetDTO) populateDTO(request);
		...
		log.debug("NFTAssetListCtl doPost End");
	}
