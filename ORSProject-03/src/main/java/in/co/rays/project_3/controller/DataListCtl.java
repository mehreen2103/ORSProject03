...
@WebServlet(name = "DataListCtl", urlPatterns = { "/ctl/DataListCtl" })
public class DataListCtl extends BaseCtl {
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op)
                ...
                if (ids != null && ids.length > 0) {
                    ...
                    DataDTO deleteBean = new DataDTO();
