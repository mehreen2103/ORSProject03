...
@WebServlet(name = "DashboardListCtl", urlPatterns = { "/ctl/DashboardListCtl" })
public class DashboardListCtl extends BaseCtl {
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op)
                ...
                if (ids != null && ids.length > 0) {
                    ...
                    DashboardDTO deleteBean = new DashboardDTO();
    ...
    protected String getView() {
        return ORSView.DASHBOARD_LIST_VIEW;
    }
}