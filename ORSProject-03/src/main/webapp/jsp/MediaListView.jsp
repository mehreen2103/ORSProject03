<%@page import="in.co.rays.project_3.controller.MediaListCtl"%>
<%@page import="in.co.rays.project_3.dto.MediaDTO"%>
...
<form action="<%=ORSView.MEDIA_LIST_CTL%>" method="post">

<jsp:useBean id="dto" class="in.co.rays.project_3.dto.MediaDTO" scope="request"></jsp:useBean>
...
<div class="container-fluid">
	...
	<h2 class="text-center text-white mb-4">Media List</h2>
