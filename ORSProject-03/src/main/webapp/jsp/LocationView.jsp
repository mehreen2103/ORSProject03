					...
					<div class="card input-group-addon">
						...
						<div class="card-body">
							...
							<%
								...
								if (dto.getCity() != null && dto.getId() > 0) {
							%>
							...
							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("city", request)%>
								...
								<div class="input-group">
									...
									<div class="input-group-prepend">
										...
										<div class="input-group-text">
											...
											<i class="fa fa-globe grey-text" style="font-size: 1rem;"></i>
							...
							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("state", request)%>
								...
								<div class="input-group">
									...
									<div class="input-group-prepend">
										...
										<div class="input-group-text">
											...
											<i class="fa fa-flag grey-text" style="font-size: 1rem;"></i>
							...
							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("country", request)%>
							...
							<div class="col-sm-12">
								...
								<div class="input-group">
									...
									<%
										...
										String statusList = HTMLUtility.getList("locationstatus", dto.getLocationstatus(), map);
									%>
							...
							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("locationstatus", request)%>
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									...
									style="font-size: 17px" value="<%=LocationCtl.OP_CANCEL%>">
