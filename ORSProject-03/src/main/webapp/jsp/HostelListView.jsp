...
<body class="hm">
	...
	<div>
		...
		<form class="pb-5" action="<%=ORSView.HOSTEL_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					...
					<input type="submit" class="btn btn-primary btn-md"
						...
						value="<%=HostelListCtl.OP_SEARCH%>"> <input type="submit"
						class="btn btn-dark btn-md" style="font-size: 15px"
						name="operation" value="<%=HostelListCtl.OP_RESET%>">
				...
				<table class="table table-bordered table-dark table-hover">
					...
					<thead>
						...
						<tr style="background-color: #8C8C8C;">
							...
							<th width="20%" class="text">Room No</th>

							<th width="20%" class="text">Capacity</th>

							<th width="20%" class="text">Join Date</th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text"><%=DataUtility.getDateString(dto.getJoinDate())%></td>

							<td class="text"><%=dto.getStatus()%></td>

							<td class="text"> <a href="HostelCtl?id=<%=dto.getId()%>">Edit</a>
			...
			<table width="100%">
				...
				<tr>
					...
					<td><input type="submit" name="operation"
						...
						value="<%=HostelListCtl.OP_NEW%>"></td>

					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" style="font-size: 17px"
						value="<%=HostelListCtl.OP_DELETE%>"></td>
			...
			<center>
				...
				<h1 style="font-size: 40px; color: #162390;">Hostel List</h1>
			...
			<div style="padding-left: 48%;">
				...
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=HostelListCtl.OP_BACK%>">
