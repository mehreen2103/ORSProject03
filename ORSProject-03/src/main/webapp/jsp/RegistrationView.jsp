...
<%@page import="in.co.rays.project_3.controller.RegistrationCtl"%>
...
<body class="hm">
	...
	<div>
		...
		<form action="<%=ORSView.REGISTRATION_CTL%>" method="post">
				...
				<div class="col-md-4 mb-4">
					...
					<div class="card input-group-addon">
						...
						<div class="card-body">
							...
							<span class="pl-sm-5"> <b>Registration Code</b> <span
							...
							<div class="col-sm-12">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control" name="registrationCode"
										...
										value="<%=DataUtility.getStringData(dto.getRegistrationCode())%>">

								</div>

							</div>

							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("registrationCode", request)%>
							...
							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("firstName", request)%>
							...
							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("lastName", request)%>
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									...
									value="<%=RegistrationCtl.OP_UPDATE%>"> <input
									type="submit" name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=RegistrationCtl.OP_CANCEL%>">
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									...
									type="submit" name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=RegistrationCtl.OP_RESET%>">
