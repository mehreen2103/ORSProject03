		...
		<form class="pb-5" action="<%=ORSView.EMPLOYEE_LIST_CTL%>"
			...
			<div class="row">
				...
				<div class="col-sm-2">
					...
					<input type="text" name="basicSalary" placeholder="Basic Salary"
						class="form-control"
						value="<%=ServletUtility.getParameter("basicSalary", request)%>">
				...
				<div class="col-sm-2">
					...
					<input type="text" name="bonus" placeholder="Bonus"
						class="form-control"
						value="<%=ServletUtility.getParameter("bonus", request)%>">
				...
				<table class="table table-bordered table-dark table-hover">
					...
					<thead>
						...
						<tr style="background-color: #8C8C8C;">
							...
							<th width="15%" class="text">Employee Code</th>

							<th width="20%" class="text">Employee Name</th>

							<th width="15%" class="text">Basic Salary</th>

							<th width="15%" class="text">Bonus</th>

							<th width="15%" class="text">Net Salary</th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text"><%=dto.getBasicSalary()%></td>

							<td class="text"><%=dto.getBonus()%></td>

							<td class="text"><%=dto.getNetsalary()%></td>

							<td class="text"><a href="EmployeeCtl?id=<%=dto.getId()%>">
									Edit </a></td>
