...
<title>Photographer List View</title>
...
<jsp:useBean id="dto" class="in.co.rays.project_3.dto.PhotographerDTO" scope="request"></jsp:useBean>
...
<div class="container-fluid">
	...
	<h2 class="text-center text-white mb-4">Photographer List</h2>
	...
	<div class="row mb-3">
		...
		<div class="col-md-3">
			<input type="submit" class="btn btn-primary"
				name="operation" value="<%=PhotographerListCtl.OP_SEARCH%>">

			<input type="submit" class="btn btn-dark"
				name="operation" value="<%=PhotographerListCtl.OP_RESET%>">
		</div>
	</div>
		...
		<table class="table table-dark table-bordered table-hover text-center">
			...
			<% while (it.hasNext()) {
				...
				<tr>
					...
					<td><%=index++%></td>
					<td><%=dto.getPhotographerName()%></td>
					<td><%=dto.getEventType()%></td>
					<td><%=dto.getCharges()%></td>
					<td>
						<a class="btn btn-sm btn-info"
							href="PhotographerCtl?id=<%=dto.getId()%>">Edit</a>
					</td>
				</tr>
			<% } %>
			</tbody>
	...
	<div class="row mt-3">
		...
		<div class="col-md-2">
			<input type="submit" name="operation"
				...
				value="<%=PhotographerListCtl.OP_NEW%>">
		</div>

		<div class="col-md-2">
			<input type="submit" name="operation"
				class="btn btn-danger"
				value="<%=PhotographerListCtl.OP_DELETE%>">
		</div>

		<div class="col-md-6 text-right">
			<input type="submit" name="operation"
				class="btn btn-secondary"
				value="<%=PhotographerListCtl.OP_NEXT%>"
