...
<body class="hm">
	...
	<div>
		<form action="<%=ORSView.TIMETABLE_LIST_CTL%>" method="post">
			...
			%>
			<center>
				<h1 class="text-primary font-weight-bold pt-3"><font color="white"> Time-Table List</h1></font>
			</center>
			</br>
			...
			<div class="row">
				...
				<div class="col-sm-3"><%=HTMLUtility.getList("courseId", String.valueOf(dto.getCourseId()), list1)%></div>
				<div class="col-sm-2">
			...
			%>
			<center>
				<h1 class="text-primary font-weight-bold pt-3">Time Table List</h1>
			</center>
			</br>
			<div class="row">
				<div class="col-md-4"></div>
