...
<%@page import="in.co.rays.project_3.dto.AccountDTO"%>
...
<body class="hm">
	...
	<div>
		...
		<form class="pb-5" action="<%=ORSView.ACCOUNT_LIST_CTL%>"
			method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					...
					<input type="text" name="accountCode"
						...
						value="<%=ServletUtility.getParameter("accountCode", request)%>">
				...
				<div class="col-sm-2">
					...
					<input type="submit" class="btn btn-primary btn-md"
						...
						value="<%=AccountListCtl.OP_SEARCH%>"> <input
						type="submit" class="btn btn-dark btn-md" style="font-size: 15px"
						name="operation" value="<%=AccountListCtl.OP_RESET%>">
				...
				<table class="table table-bordered table-dark table-hover">
					...
					<thead>
						...
						<tr style="background-color: #8C8C8C;">
							...
							<th width="20%" class="text">Account Code</th>

							<th width="20%" class="text">Username</th>

							<th width="20%" class="text">Account Type</th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text"><%=dto.getAccountCode()%></td>

							<td class="text"><%=dto.getUsername()%></td>

							<td class="text"><%=dto.getAccountType()%></td>

							<td class="text"><%=dto.getStatus()%></td>

							<td class="text"><a href="AccountCtl?id=<%=dto.getId()%>">
			...
			<table width="100%">
				...
				<tr>
					...
					<td><input type="submit" name="operation"
						...
						value="<%=AccountListCtl.OP_NEW%>"></td>

					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" style="font-size: 17px"
						value="<%=AccountListCtl.OP_DELETE%>"></td>
			...
			<center>
				...
				<h1 style="font-size: 40px; color: #162390;">Account List</h1>
			...
			<div style="padding-left: 48%;">
				...
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=AccountListCtl.OP_BACK%>">
