...
<%@page import="in.co.rays.project_3.controller.PasswordCtl"%>
				...
				<div class="col-md-4 mb-4">
					...
					<div class="card input-group-addon">
						...
						<div class="card-body">
							...
							<span class="pl-sm-5"> <b>Password Code</b> <span
							...
							<div class="col-sm-12">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control" name="passwordCode"
										placeholder="Enter Password Code"
										value="<%=DataUtility.getStringData(dto.getPasswordCode())%>">

								</div>

							</div>

							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("passwordCode", request)%>
							...
							<span class="pl-sm-5"> <b>Password Value</b> <span
								style="color: red;">*</span>
							</span> <br>
							...
							<div class="col-sm-12">
								...
								<div class="input-group">
									...
									<input type="password" class="form-control"
										name="passwordValue" placeholder="Enter Password Value"
										value="<%=DataUtility.getStringData(dto.getPasswordValue())%>">

								</div>

							</div>

							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("passwordValue", request)%>
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									...
									value="<%=PasswordCtl.OP_UPDATE%>"> <input
									type="submit" name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=PasswordCtl.OP_CANCEL%>">
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									class="btn btn-success btn-md" style="font-size: 17px"
									value="<%=PasswordCtl.OP_SAVE%>"> <input type="submit"
									name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=PasswordCtl.OP_RESET%>">
