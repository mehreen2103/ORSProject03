				...
				<div class="col-md-4 mb-4">
					...
					<div class="card input-group-addon">
						...
						<div class="card-body">
							...
							<h3 class="text-center default-text text-primary">ADD HOSTEL
							</h3>
							...
							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("roomNo", request)%>
							...
							<span class="pl-sm-5"> <b>Join Date</b> <span
								style="color: red;">*</span>
							...
							<div class="col-sm-12">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control" id="datepicker"
										name="joinDate" placeholder="Enter Join Date"
										readonly="readonly"
										value="<%=DataUtility.getDateString(dto.getJoinDate())%>">

								</div>

							</div>

							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("joinDate", request)%>
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									...
									value="<%=HostelCtl.OP_UPDATE%>"> <input type="submit"
									name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=HostelCtl.OP_CANCEL%>">
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									class="btn btn-success btn-md" style="font-size: 17px"
									value="<%=HostelCtl.OP_SAVE%>"> <input type="submit"
									name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=HostelCtl.OP_RESET%>">
