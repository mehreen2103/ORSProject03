...
.hm {
	...
	background-image:
		url('<%=ORSView.APP_CONTEXT%>/img/stars.jpeg');
...
.card-body {
	...
	background-image:
		linear-gradient(to bottom right, #472372, #e4d0ff);
...
<body class="hm">
	...
	<div>
		...
		<form action="<%=ORSView.USERPROFILE_CTL%>" method="post">

			<jsp:useBean id="dto" class="in.co.rays.project_3.dto.UserProfileDTO" scope="request">
			</jsp:useBean>
						...
						<div class="card-body">
							...
							<div class="col-sm-12">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control" name="profileCode" placeholder="Profile Code"
										value="<%=DataUtility.getStringData(dto.getProfileCode())%>">
							...
							<font color="red" class="pl-sm-5">
								...
								<%=ServletUtility.getErrorMessage("profileCode", request)%>
							...
							<div class="col-sm-12">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control" maxlength="10" name="mobileNo" placeholder="Mobile No"
	                       ...
	                       <div class="input-group">
		                       ...
		                       <div class="input-group-prepend">
			                     ...
			                     <div class="input-group-text">
				                   ...
				                   <i class="fa fa-check-circle grey-text" style="font-size: 1rem;"></i>
