...
<script type="text/javascript" src="<%=ORSView.APP_CONTEXT%>/js/CheckBox11.js">
</script>
...
<body class="hm">
	...
	<div>
		...
		<form class="pb-5" action="<%=ORSView.USERPROFILE_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					...
					<input type="text" name="profileCode" placeholder="Enter Profile Code" class="form-control"
				...
				<div class="col-sm-2">
					...
					<input type="text" name="mobileNo" placeholder="Enter Mobile No"class="form-control"
				...
				<div class="col-sm-2">
					...
					<input type="submit" class="btn btn-primary btn-md" style="font-size: 15px" name="operation"
						value="<%=UserProfileListCtl.OP_SEARCH%>">

					<input type="submit" class="btn btn-dark btn-md" style="font-size: 15px" name="operation"

						value="<%=UserProfileListCtl.OP_RESET%>">
				...
				<table class="table table-bordered table-dark table-hover">
					...
					<thead>
						<tr	style="background-color: #8C8C8C;">
							...
							<th width="10%">
								...
								<input type="checkbox" id="select_all" name="Select" class="text">Select All</th>

							<th width="5%"class="text">	S.NO</th>

							<th width="20%"class="text">Profile Code</th>

							<th width="20%"class="text">User Name</th>

							<th width="20%"class="text">Mobile No</th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text"><a href="UserProfileCtl?id=<%=dto.getId()%>">Edit</a></td>
			...
			<table width="100%">
				...
				<tr>
					...
					<td>
						...
						<input type="submit"name="operation" class="btn btn-warning btn-md" style="font-size: 17px"
							value="<%=UserProfileListCtl.OP_PREVIOUS%>"<%=pageNo > 1 ? "": "disabled"%>>
					...
					<td>
						...
						<input type="submit" name="operation"class="btn btn-primary btn-md" style="font-size: 17px"
							value="<%=UserProfileListCtl.OP_NEW%>">

					</td>

					<td>

						<input type="submit" name="operation"class="btn btn-danger btn-md" style="font-size: 17px"
							value="<%=UserProfileListCtl.OP_DELETE%>">
					...
					<td align="right">
						...
						<input type="submit" name="operation" class="btn btn-warning btn-md"style="font-size: 17px"
							value="<%=UserProfileListCtl.OP_NEXT%>"<%=(nextPageSize != 0)? "": "disabled"%>>
			...
			<center>
				...
				<h1 style="font-size: 40px; color: #162390;">User Profile List</h1>
			...
			<div style="padding-left: 48%;">
				...
				<input type="submit"name="operation" class="btn btn-primary btn-md" style="font-size: 17px"
					value="<%=UserProfileListCtl.OP_BACK%>">
