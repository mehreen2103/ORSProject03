					...
					<div class="card input-group-addon">
						...
						<div class="card-body">
							...
							<%
								...
								if (dto.getAssetName() != null && dto.getId() > 0) {
							%>

							<h3 class="text-center default-text text-primary">UPDATE NFT ASSET</h3>

							<%
								} else {
							%>

							<h3 class="text-center default-text text-primary">ADD NFT ASSET</h3>
							...
							<span class="pl-sm-5"> <b>NFT Code</b> <span
								...
								<div class="input-group">
									...
									<div class="input-group-prepend">
										...
										<div class="input-group-text">
											...
											<i class="fa fa-code grey-text" style="font-size: 1rem;"></i>
							...
							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("nftCode", request)%>
							</font> <br>
								...
								<div class="input-group">
									...
									<div class="input-group-prepend">
										...
										<div class="input-group-text">
											...
											<i class="fa fa-gem grey-text" style="font-size: 1rem;"></i>
							...
							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("assetName", request)%>
							</font> <br>
							...
							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("ownerName", request)%>
							</font> <br>
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									...
									style="font-size: 17px" value="<%=NFTAssetCtl.OP_CANCEL%>">
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									class="btn btn-success btn-md" style="font-size: 17px"
									value="<%=NFTAssetCtl.OP_SAVE%>"> <input type="submit"
									name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=NFTAssetCtl.OP_RESET%>">
