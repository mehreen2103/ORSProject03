...
<body class="hm">
	...
	<div>
		<form action="<%=ORSView.SUBJECT_LIST_CTL%>" method="post">
			...
			%>
			<center>
						<h1 class="text-primary font-weight-bold pt-3"><font color="white">
							Subject List</h1></font>
					</center>
					</br>
			...
			<div class="row">
				...
				<div class="col-sm-3"><%=HTMLUtility.getList("courseId", String.valueOf(dto.getCourseId()), list2)%></div>
				<div class="col-sm-2">
