					...
					<div class="card input-group-addon">
						...
						<div class="card-body">
							...
							<%
								...
								if (dto.getEmployeeName() != null && dto.getId() > 0) {
							%>
							...
							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("employeeCode", request)%>
							</font> <br>
							...
							<span class="pl-sm-5"> <b>Basic Salary</b> <span
								style="color: red;">*</span>
							</span> <br>
							...
							<div class="col-sm-12">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control" name="basicSalary"
										...
										value="<%=DataUtility.getStringData(dto.getBasicSalary())%>">

								</div>

							</div>

							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("basicSalary", request)%>
							</font> <br>

							<!-- Bonus -->

							<span class="pl-sm-5"> <b>Bonus</b> <span
								style="color: red;">*</span>
							</span> <br>
								...
								<div class="input-group">
									...
									<div class="input-group-prepend">
										...
										<div class="input-group-text">
											...
											<i class="fa fa-gift grey-text" style="font-size: 1rem;"></i>
									...
									<input type="text" class="form-control" name="bonus"
										...
										value="<%=DataUtility.getStringData(dto.getBonus())%>">

								</div>

							</div>

							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("bonus", request)%>
							</font> <br>

							<!-- Net Salary -->

							<span class="pl-sm-5"> <b>Net Salary</b> <span
								style="color: red;">*</span>
							</span> <br>
							...
							<div class="col-sm-12">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control" name="netsalary"
										...
										value="<%=DataUtility.getStringData(dto.getNetsalary())%>">

								</div>

							</div>

							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("netsalary", request)%>
							</font> <br>
