...
<body class="p4">
	...
	<div>
		<form action="<%=ORSView.EVENT_LIST_CTL%>" method="post">
			...
			<%
				HashMap list1 = (HashMap) request.getAttribute("categoryL");
			%>
			<%
			...
			<center>
				...
				<center>
					...
					<div class="row">
						...
						&emsp;
						<div class="col-sm-3">
							<%=HTMLUtility.getList("category", dto.getCategory(), list1)%>
						</div>
						&emsp;
						<div class="col-sm-2">
							<input type="submit" class="btn btn-primary btn-md"
								style="font-size: 17px" name="operation"
								value="<%=EventListCtl.OP_SEARCH%>">&emsp; <input
						...
						<table class="table table-dark table-bordered">
							...
							<tbody>
								<tr>
									...
									<td align="center"><%=dto.getEventName()%></td>
									<td align="center"><%=dto.getEventDate()%></td>
									<td align="center"><%=dto.getEventType()%></td>
									<td align="center"><%=dto.getCategory()%></td>
									<td align="center"><a href="EventCtl?id=<%=dto.getId()%>">Edit</a></td>
								</tr>
							</tbody>
							<%
								}
					...
					<table width="100%">
						<tr>
							...
							<td align="right"><input type="submit" name="operation"
								class="btn btn-secondary btn-md" style="font-size: 17px"
								style="padding: 5px;" value="<%=EventListCtl.OP_NEXT%>"
					...
					%>
					<center>
						<h1 class="text-primary font-weight-bold pt-3">Event List</h1>
					</center>
